...
const previewCloseButton = document.querySelector(".modal__close-btn_type_preview")

previewModalImageEl = previewModal.querySelector(".modal__image");
previewModalCaptionEl = previewModal.querySelector(".modal__caption");
